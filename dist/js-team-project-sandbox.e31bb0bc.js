...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"booksApi.js":[function(require,module,exports) {
var define;
"use strict";
...
_axios.default.defaults.baseURL = API_ENDPOINTS.baseUrl;
...
var getTopBooks = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.get(API_ENDPOINTS.topBooks);
        case 3:
  ...
  return function getTopBooks() {
    return _ref2.apply(this, arguments);
  };
}();
var getBooksByCategory = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(category) {
    var result;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _axios.default.get(API_ENDPOINTS.categoryBooks, {
            params: {
              category: category
            }
          });
  ...
  return function getBooksByCategory(_x) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _axios.default.get(API_ENDPOINTS.book + id);
        case 3:
...
var useBooksApi = function useBooksApi() {
  return {
...
var handleOnPress = function handleOnPress(e) {
  e.preventDefault();
  _state.state.isLoading = true;
  _state.state.isError = false;
  booksApi.getCategoryList().then(function (res) {
    _state.state.data = res;
...
//# sourceMappingURL=/js-team-project-sandbox.e31bb0bc.js.map